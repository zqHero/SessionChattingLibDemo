...
public class EmotionItemPageView extends RelativeLayout {
    ...
    public EmotionItemPageView(Context context) {
        this(context, null);
    }

    public EmotionItemPageView(Context context, AttributeSet attrs) {
        super(context, attrs);
